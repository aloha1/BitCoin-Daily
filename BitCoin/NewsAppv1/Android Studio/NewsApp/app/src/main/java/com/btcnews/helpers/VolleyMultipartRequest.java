...
//    }
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
       ...
       // headers.put("Content-Type", "multipart/form-data; boundary=" + boundary + "; charset=" + getParamsEncoding());
        return headers;
    }
...
//    @Override
//    public String getBodyContentType() {
//        return "multipart/form-data; boundary=" + boundary + "; charset=" + getParamsEncoding();
//    }
